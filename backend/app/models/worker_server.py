...
class WorkerServer(Base):
    ...
    total_memory = Column(Integer, default=600, nullable=False)  # Total memory in MB
    available_memory = Column(Integer, default=600, nullable=False)  # Available memory in MB
