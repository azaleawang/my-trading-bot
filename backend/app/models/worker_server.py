...
class WorkerServer(Base):
    ...
    total_memory = Column(Integer, default=550, nullable=False)  # Total memory in MB
    available_memory = Column(Integer, default=550, nullable=False)  # Available memory in MB
